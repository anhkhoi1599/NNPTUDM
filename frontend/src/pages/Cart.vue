            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                            ...
                            <div class="box-title item-total row">
                                <h3>
                                    <p style="font-size: 15px;">{{ filterFoods.length.toString() }}
                                        <span v-if="filterFoods.length < 2">Mặt Hàng</span>
                                        <span v-else>items</span>
                                    </p>Trong Giỏ Hàng Của Bạn
                                </h3>
                            </div>
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Tiếp tục mua hàng</router-link>
                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Tóm Lược</span>
                                <h3 class="font-bold total-first-price">{{ calculateSummaryPrice()[0] }}VND</h3>

                                <span>Chiết Khấu</span>
                                <h3 class="font-bold total-discount">{{ calculateSummaryPrice()[1] }}VND</h3>

                                <span>Phí Giao Hàng</span>
                                <h3 class="font-bold total-delivery">{{ calculateSummaryPrice()[2] }}VND</h3>

                                <hr />

                                <span>Tổng Cộng</span>
                                <h2 class="font-bold total-sale">{{ calculateSummaryPrice()[3] }}VND</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +84 975 695 547</h3>
                                <span class="small">
