        ...
        <div class="register-form-container">
            <form id="registerForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <label for="uName">Điền Tên Của Bạn:
                    </label>
                    <input type="text" name="uName" placeholder="Tên đầy đủ của bạn" id="uName" class="form-control"
                        v-model="registerObj.name" />
                    <p class="error-mess" v-if="errorObj.nameErr.length > 0">{{ errorObj.nameErr[0] }}</p>
                </div>

                <div class="form-group">
                    <label for="uEmail">Nhập Email Của Bạn:
                    </label>
                ...
                <div class="form-group">
                    <label for="uPass">Nhập Mật Khẩu Của Bạn:
                    </label>
                    <input type="password" name="uPass" placeholder="Nhập Mật Khẩu Của Bạn" id="uPass"
                        class="form-control" v-model="registerObj.pass" />
                    <p class="error-mess" v-if="errorObj.passErr.length > 0">{{ errorObj.passErr[0] }}</p>
                </div>

                <div class="form-group">
                    <label for="uPassConfirm">Kiểm Tra Lại Mật Khẩu Của Bạn:
                    </label>
                    <input type="password" name="uPassConfirm" placeholder="Nhập Mật Khẩu Của Bạn" id="uPassConfirm"
                ...
                <div class="form-group">
                    <label for="uPhone">Nhập Số Điện Thoại Của Bạn:
                    </label>
                    <input type="tel" name="uPhone" placeholder="Nhập Số Điện Thoại Của Bạn:" id="uPhone"
                        class="form-control" v-model="registerObj.phone" />
                    <p class="error-mess" v-if="errorObj.phoneErr.length > 0">{{ errorObj.phoneErr[0] }}</p>
                </div>

                <div class="form-group">
                    <label for="uBirth">Nhập Ngày Sinh Của Bạn:
                    </label>
                ...
                <div class="form-group">
                    <label for="">Chọn Giới Tính Của Bạn:
                    </label>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <p>Đã có tài khoản? <router-link @click="scrollToTop()" to="/login">Đăng Nhập</router-link>
                    </p>
                </div>
            </form>
        </div>
