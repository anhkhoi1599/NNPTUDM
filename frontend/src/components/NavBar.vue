<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />NHOM HLKL
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">trang chủ</router-link>
            <router-link @click="scrollToTop()" to="/about">Thông tin</router-link>
            <!-- <router-link @click="scrollToTop()" to="/promotions">promotions</router-link> -->
            <router-link @click="scrollToTop()" to="/menu">thực đơn</router-link>
            <router-link @click="scrollToTop()" to="/table">đặt bàn</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Đơn hàng của bạn</router-link>
                    </li>
                    <li>
